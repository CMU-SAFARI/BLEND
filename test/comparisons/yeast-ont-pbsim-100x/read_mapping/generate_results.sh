...
echo "chrI:"
blend_strobemers_chrI=$(cat blend_strobemers.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrI") print $1}' | sort | uniq | awk 'END {x = NR/2548; printf "%.4f\n", x}')
echo $blend_strobemers_chrI;
echo "chrII:"
blend_strobemers_chrII=$(cat blend_strobemers.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrII") print $1}' | sort | uniq | awk 'END {x = NR/9083; printf "%.4f\n", x}')
echo $blend_strobemers_chrII;
echo "chrIII:"
blend_strobemers_chrIII=$(cat blend_strobemers.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIII") print $1}' | sort | uniq | awk 'END {x = NR/3557; printf "%.4f\n", x}')
echo $blend_strobemers_chrIII;
echo "chrIV:"
blend_strobemers_chrIV=$(cat blend_strobemers.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIV") print $1}' | sort | uniq | awk 'END {x = NR/16822; printf "%.4f\n", x}')
echo $blend_strobemers_chrIV;
echo "chrV:"
blend_strobemers_chrV=$(cat blend_strobemers.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrV") print $1}' | sort | uniq | awk 'END {x = NR/6496; printf "%.4f\n", x}')
echo $blend_chrV;
...
echo "chrI:"
minimap2_eq_chrI=$(cat minimap2_eq.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrI") print $1}' | sort | uniq | awk 'END {x = NR/2548; printf "%.4f\n", x}')
echo $minimap2_eq_chrI;
echo "chrII:"
minimap2_eq_chrII=$(cat minimap2_eq.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrII") print $1}' | sort | uniq | awk 'END {x = NR/9083; printf "%.4f\n", x}')
echo $minimap2_eq_chrII;
echo "chrIII:"
minimap2_eq_chrIII=$(cat minimap2_eq.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIII") print $1}' | sort | uniq | awk 'END {x = NR/3557; printf "%.4f\n", x}')
echo $minimap2_eq_chrIII;
echo "chrIV:"
minimap2_eq_chrIV=$(cat minimap2_eq.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIV") print $1}' | sort | uniq | awk 'END {x = NR/16822; printf "%.4f\n", x}')
echo $minimap2_eq_chrIV;
echo "chrV:"
minimap2_eq_chrV=$(cat minimap2_eq.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrV") print $1}' | sort | uniq | awk 'END {x = NR/6496; printf "%.4f\n", x}')
