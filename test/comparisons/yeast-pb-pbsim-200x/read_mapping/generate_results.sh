...
echo $blend_chrI;
echo "chrII:"
blend_chrII=$(cat blend.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrII") print $1}' | sort | uniq | awk 'END {x = NR/18074; printf "%.4f\n", x}')
echo $blend_chrII;
echo "chrIII:"
blend_chrIII=$(cat blend.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIII") print $1}' | sort | uniq | awk 'END {x = NR/6997; printf "%.4f\n", x}')
echo $blend_chrIII;
echo "chrIV:"
blend_chrIV=$(cat blend.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIV") print $1}' | sort | uniq | awk 'END {x = NR/34163; printf "%.4f\n", x}')
echo $blend_chrIV;
echo "chrV:"
...
echo "chrI:"
minimap2_chrI=$(cat minimap2.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrI") print $1}' | sort | uniq | awk 'END {x = NR/5139; printf "%.4f\n", x}')
echo $minimap2_chrI;
echo "chrII:"
minimap2_chrII=$(cat minimap2.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrII") print $1}' | sort | uniq | awk 'END {x = NR/18074; printf "%.4f\n", x}')
echo $minimap2_chrII;
echo "chrIII:"
minimap2_chrIII=$(cat minimap2.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIII") print $1}' | sort | uniq | awk 'END {x = NR/6997; printf "%.4f\n", x}')
echo $minimap2_chrIII;
echo "chrIV:"
minimap2_chrIV=$(cat minimap2.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIV") print $1}' | sort | uniq | awk 'END {x = NR/34163; printf "%.4f\n", x}')
echo $minimap2_chrIV;
echo "chrV:"
...
echo "Precision (LRA)"
echo "chrI:"
lra_chrI=$(cat lra.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrI") print $1}' | sort | uniq | awk 'END {x = NR/5139; printf "%.4f\n", x}')
echo $lra_chrI;
echo "chrII:"
lra_chrII=$(cat lra.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrII") print $1}' | sort | uniq | awk 'END {x = NR/18074; printf "%.4f\n", x}')
echo $lra_chrII;
echo "chrIII:"
lra_chrIII=$(cat lra.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIII") print $1}' | sort | uniq | awk 'END {x = NR/6997; printf "%.4f\n", x}')
echo $lra_chrIII;
echo "chrIV:"
lra_chrIV=$(cat lra.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIV") print $1}' | sort | uniq | awk 'END {x = NR/34163; printf "%.4f\n", x}')
echo $lra_chrIV;
echo "chrV:"
lra_chrV=$(cat lra.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrV") print $1}' | sort | uniq | awk 'END {x = NR/12936; printf "%.4f\n", x}')
echo $lra_chrV;

echo "Precision (Winnowmap)"
echo "chrI:"
winnowmap_chrI=$(cat winnowmap.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrI") print $1}' | sort | uniq | awk 'END {x = NR/5139; printf "%.4f\n", x}')
echo $winnowmap_chrI;
echo "chrII:"
winnowmap_chrII=$(cat winnowmap.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrII") print $1}' | sort | uniq | awk 'END {x = NR/18074; printf "%.4f\n", x}')
echo $winnowmap_chrII;
echo "chrIII:"
winnowmap_chrIII=$(cat winnowmap.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIII") print $1}' | sort | uniq | awk 'END {x = NR/6997; printf "%.4f\n", x}')
echo $winnowmap_chrIII;
echo "chrIV:"
winnowmap_chrIV=$(cat winnowmap.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIV") print $1}' | sort | uniq | awk 'END {x = NR/34163; printf "%.4f\n", x}')
echo $winnowmap_chrIV;
echo "chrV:"
winnowmap_chrV=$(cat winnowmap.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrV") print $1}' | sort | uniq | awk 'END {x = NR/12936; printf "%.4f\n", x}')
echo $winnowmap_chrV;

echo "Precision (S-conLSH)"
echo "chrI:"
conlsh_chrI=$(cat conlsh.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrI") print $1}' | sort | uniq | awk 'END {x = NR/5139; printf "%.4f\n", x}')
echo $conlsh_chrI;
echo "chrII:"
conlsh_chrII=$(cat conlsh.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrII") print $1}' | sort | uniq | awk 'END {x = NR/18074; printf "%.4f\n", x}')
echo $conlsh_chrII;
echo "chrIII:"
conlsh_chrIII=$(cat conlsh.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIII") print $1}' | sort | uniq | awk 'END {x = NR/6997; printf "%.4f\n", x}')
echo $conlsh_chrIII;
echo "chrIV:"
conlsh_chrIV=$(cat conlsh.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrIV") print $1}' | sort | uniq | awk 'END {x = NR/34163; printf "%.4f\n", x}')
echo $conlsh_chrIV;
echo "chrV:"
conlsh_chrV=$(cat conlsh.bam.joined.bed | awk -v FS=' ' '{if($2 == "chrV") print $1}' | sort | uniq | awk 'END {x = NR/12936; printf "%.4f\n", x}')
echo $conlsh_chrV;
