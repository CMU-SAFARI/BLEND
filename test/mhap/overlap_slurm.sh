...
mkdir -p ${OUTDIR}
sbatch -o ${OUTDIR}/${PREFIX}.out -e ${OUTDIR}/${PREFIX}.err -c ${THREAD} -J ${PREFIX} ${SLURM_OPTIONS} --wrap="bash ../scripts/mhap-overlap-hifi.sh ${OUTDIR} ${PREFIX} ${READS} ${THREAD} ../scripts/"
...
mkdir -p ${OUTDIR}
sbatch -o ${OUTDIR}/${PREFIX}.out -e ${OUTDIR}/${PREFIX}.err -c ${THREAD} -J ${PREFIX} ${SLURM_OPTIONS} --wrap="bash ../scripts/mhap-overlap.sh ${OUTDIR} ${PREFIX} ${READS} ${THREAD} ../scripts/"
