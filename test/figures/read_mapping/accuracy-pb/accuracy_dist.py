...
def main():
    ...
    for f in args.input:
        ...
        enums = ['BLEND','Minimap2', 'LRA', 'Winnowmap', 'S-conLSH','d','e','f','g','h','i','j','k','l','m','n','o','p','r','s','t','u','v','w','x','y','z']
        with open(f, 'r') as csvfile:
            ...
            plt.subplots_adjust(top=0.995, bottom=0.05, left=0.09, right=0.99, hspace=0.23, wspace=0.2)
