...
uint64_t calculate_blend(const char *str, const int start, const int k, const int w, const int z, const int is_hpc, const uint64_t blendStart, const uint64_t mask, const uint64_t shift1, int16_t* blendValCnt, int* first_span);
...
void mm_sketch(void *km, const char *str, int len, int w, int blend_bits, int k, int k_shift, uint32_t rid, int is_hpc, int is_minimizer, mm128_v *p);
